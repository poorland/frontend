...
function init() {
    ...
    container = document.getElementById('tugou-second-map');
    ...
    camera = new THREE.PerspectiveCamera(45, CANVAS_WIDTH / CANVAS_HEIGHT, 0.00001, 2000);
    ...
    loader.load('poorland_2.glb', function (gltf) {
